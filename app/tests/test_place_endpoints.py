...
class PlaceEndpointsTestCase(unittest.TestCase):
    ...
    def test_create_place(self):
        response = self.client.post('/api/api_places/', data=json.dumps({
            'name': 'New Place',
    ...
    def test_get_place(self):
        ...
        response = self.client.get(f'/api/api_places/{place_id}')
    ...
    def test_update_place(self):
        ...
        self.assertEqual(response.status_code, 201)
        place_id = response.get_json()['id']
        response = self.client.put(f'/api/api_places/{place_id}', data=json.dumps({
            'name': 'Updated Place',
    ...
    def test_delete_place(self):
        ...
        self.assertEqual(response.status_code, 201)
        place_id = response.get_json()['id']
        response = self.client.delete(f'/api/api_places/{place_id}')
